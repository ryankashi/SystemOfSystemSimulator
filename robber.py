...
class Robber(ConstituientSystem):
	def __init__(self):
		super(Robber, self).__init__(3)
	...
	def get_observations(self,grid):
		...
		masked_grid = mask_grid(self,grid,5)
		#self.observations = masked_grid
	...
	def start(self,w0file = None, w1file = None):
		...
		print 'Robber ready for simulation'
